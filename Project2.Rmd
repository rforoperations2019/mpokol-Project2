...
ggplot(admin_data_excel, aes(x=NAME_1)) + geom_bar()

```

```{r}

#ggplot(admin_data_excel, aes(x=TYPE_2)) + geom_bar()
ggplot(admin_data_excel, ggplot2::aes(area = NAME_1, fill = TYPE_2)) + geom_treemap()
```
